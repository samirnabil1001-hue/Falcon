<x-app-layout>
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 md:p-6 h-full flex flex-col">

        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-4 shrink-0">
            User Management
        </h3>
                                ...
                                <td class="p-3 text-center" dir="ltr">
                                    ...
                                    @else
                                        <span
                                            ...
                                            <span class="w-2 h-2 me-2 bg-gray-400 rounded-full"></span>
                                            Inactive
                                        </span>
                                    @endif
                                </td>
