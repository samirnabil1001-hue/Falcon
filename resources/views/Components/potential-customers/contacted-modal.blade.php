                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:text-right w-full">
                            ...
                            <div class="mt-4 space-y-4 text-sm text-gray-500 dark:text-slate-400">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">السبب (Reason)</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">تاريخ ووقت المتابعة القادم</label>
