        ...
        <div class="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-4 py-4 border-b border-slate-100 dark:border-slate-800/60 mb-6"
            ...
            <div class="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto justify-end">
                ...
                <select name="year" onchange="window.location.href = this.value"
                    class="text-sm border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 focus:ring-blue-500">
                    <option value="{{ request()->fullUrlWithQuery(['year' => null]) }}">كل السنوات</option>
                ...
                <select name="month" onchange="window.location.href = this.value"
                    class="text-sm border-slate-200 dark:border-slate-700 rounded-xl bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 focus:ring-blue-500">
                    <option value="{{ request()->fullUrlWithQuery(['month' => null]) }}">كل الشهور</option>
                    @foreach (range(1, 12) as $month)
                        <option value="{{ request()->fullUrlWithQuery(['month' => $month]) }}"
