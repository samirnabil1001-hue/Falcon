        ...
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 py-2">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('potential-customers.create') }}"
                    class="flex items-center px-5 py-2.5 text-sm font-semibold text-slate-800 border-slate-200 rounded-xl dark:bg-indigo-600 border border-transparent shadow-none">
            ...
            <div
                ...
                <h3 class="text-slate-700 dark:text-slate-200 text-sm font-bold mb-1 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor" class="w-4 h-4 text-emerald-500">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707M14 12a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                    كفاءة الحسم والإغلاق
                </h3>
