                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            ...
                            @endphp
                            <span class="inline-flex items-center gap-1 rounded-full px-2 py-1 text-xs font-semibold {{ $color }}">
                                {{ $log->method }}
                            </span>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <code class="text-xs bg-gray-100 p-1 rounded text-gray-600">{{ $log->ip_address }}</code>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm">
                             
                                <div class="font-medium text-gray-700">{{ \Carbon\Carbon::parse($log->created_at)->format('Y-m-d') }}</div>
                                <div class="text-gray-400 text-xs">{{ \Carbon\Carbon::parse($log->created_at)->format('H:i:s') }}</div>
                            </div>
                        </td>
                    </tr>
                    @endforeach
