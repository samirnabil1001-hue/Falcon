<div x-show="showCancelledModal" class="fixed inset-0 z-50 overflow-y-auto" style="display: none;"
    aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div x-show="showCancelledModal" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0"
        ...
        <div x-show="showCancelledModal" x-transition:enter="ease-out duration-300"
            ...
            <form action="{{ $route }}" method="POST" class="m-0">
                ...
                <input type="hidden" name="status" value="{{ \App\Enums\PotentialCustomerStatus::CANCELLED->value }}">
                    ...
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:text-right w-full">
                            ...
                            <div class="mt-4 space-y-4 text-sm text-gray-500 dark:text-slate-400">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1">سبب
                                        الإلغاء</label>
