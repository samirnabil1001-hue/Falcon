<x-app-layout>
    ...
    class="bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-800 p-5 md:p-6 h-[calc(100vh-12rem)] lg:h-[calc(100vh-7rem)] flex flex-col overflow-hidden transition-colors duration-300 text-right" dir="rtl">
        ...
        <div class="flex-1 h-0 overflow-hidden rounded-xl border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm mt-4">
            <div class="h-full overflow-auto custom-scrollbar">
                <table class="w-full min-w-[1000px] border-collapse text-right">
                    ...
                    <thead class="sticky top-0 z-20 bg-gray-50/90 dark:bg-slate-800/90 backdrop-blur-md border-b border-gray-200 dark:border-slate-700 text-gray-600 dark:text-slate-300 text-xs uppercase">
                        <tr>
                            ...
                            <th scope="col" class="p-4 font-bold tracking-wider text-left" dir="ltr">رقم الهاتف</th>
                            ...
                            <th scope="col" class="p-4 font-bold tracking-wider text-center w-48 min-w-[190px]">إجراءات</th>
                        </tr>
                    </thead>
                            ...
                            <tr class="hover:bg-slate-50/60 dark:hover:bg-slate-800/40 transition-colors group">
                                ...
                                <td class="p-4 whitespace-nowrap text-right">
                                    <div class="flex items-center gap-3">
                                        <div class="w-9 h-9 rounded-xl bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400 flex items-center justify-center font-bold text-sm border border-indigo-100/50 dark:border-indigo-900/30">
                                ...
                                <!-- رقم الهاتف -->
                                <td class="p-4 whitespace-nowrap text-left text-xs font-medium text-gray-600 dark:text-slate-300 font-mono tracking-wide" dir="ltr">
                                    {{ $customer->phone }}
                                </td>
                                ...
                                <td class="p-4 text-center whitespace-nowrap">
                                    <span class="inline-flex items-center justify-center px-2.5 py-1 text-xs font-bold bg-gray-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300 rounded-lg border border-gray-200 dark:border-slate-700">
                                ...
                                <td class="p-4 text-center text-xs max-w-xs truncate">
                                    @if ($customer->followUps->first())
                                        ...
                                        <div class="text-[10px] text-gray-400 dark:text-slate-500 mt-1 flex items-center justify-center gap-1">
                                    ...
                                    @else
                                        <span class="text-gray-300 dark:text-slate-600 italic font-normal">لا توجد متابعات سابقة</span>
                                    @endif
                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="p-12 text-center text-gray-400 dark:text-slate-500 italic text-sm">
                                    <div class="flex flex-col items-center justify-center gap-2">
                                        <svg class="w-8 h-8 text-gray-300 dark:text-slate-700" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
